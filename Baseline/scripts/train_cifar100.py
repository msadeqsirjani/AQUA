"""
Baseline — CIFAR-100 Experiment (full-precision training).
...
Run from project root:
  python -m Baseline.scripts.train_cifar100
"""
...
from Baseline.models.models import ResNet18
...
SEED           = 42
SAVE_DIR       = 'results/Baseline/CIFAR-100'
...
if __name__ == '__main__':
    ...
    print(f'Baseline CIFAR-100  |  device={DEVICE}  |  seed={SEED}  |  {bitwidth_str}')
